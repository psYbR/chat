...
socket.on('chat message', (msg) => {
  store.dispatch(addMessage({ type: 'inbound', channelId: 1, timestamp:  getNowTimestamp(), source: 'anon', messageText: msg, messageSent: true }));
});
...
store.dispatch(addMessage({ type: 'inbound', channelId: 1, timestamp:  getNowTimestamp()-17, source: '*', messageText: "Welcome to the channel!", messageSent: true }));
