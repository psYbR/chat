...
import { setConnected, setDisconnected, setDefaultChannelsReceived, updatePing } from './actions/userInterfaceActions';
...
store.dispatch(addMessage({ type: 'inbound', channelId: 1, receivedTimestamp:  getNowTimestamp()-2, source: '*', messageText: "Welcome to the channel!", messageSent: true }));
