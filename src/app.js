...
store.dispatch(addChannel({ channelId: 1, channelName: 'lobby', type: 'channel', topic: 'Welcome to the lobby', isJoined: false, isCurrent: false }));
...
store.dispatch(addMessage({ type: 'inbound', channelId: 1, timestamp:  getNowTimestamp()-15, source: 'Colors', messageSent: true, messageText: "^1,0A^0,1B^1,2C^2,3D^3,4E^4,5F^5,6G^6,7H^7,8I^8,9J^9,10K^10,11L^11,12M^12,13N^13,14O^14,15P^15,16Q^16,17R" }));
